...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään Olidesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa Olidesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi Olideskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava Olideskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava Olideskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten Olidesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota Olideskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli Olidesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "Olidesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa Olideskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "Olidesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep Olidesk background service", "Pidä Olideskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista Olideskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("verify_Olidesk_password_tip", "Vahvista Olidesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "Olidesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_Olidesk_server_pro_to_{}_tip", "Päivitä Olidesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About Olidesk", "Tietoa Olideskistä"),
        ...
        ("upgrade_remote_Olidesk_client_to_{}_tip", "Päivitä etä-Olidesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
