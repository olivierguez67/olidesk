...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới Olidesk..."),
        ...
        ("install_tip", "Do cơ chế UAC, Olidesk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt Olidesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho Olidesk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho Olidesk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [Olidesk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep Olidesk background service", "Giữ dịch vụ Olidesk chạy nền"),
        ...
        ("verify_Olidesk_password_tip", "Xác thực mật khẩu Olidesk"),
        ...
        ("scam_text2", "Chỉ sử dụng Olidesk với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_Olidesk_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ Olidesk mở"),
        ...
        ("floating_window_tip", "Giữ Olidesk trên cùng"),
        ...
        ("upgrade_remote_Olidesk_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
