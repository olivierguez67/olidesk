...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua Olidesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca Olidesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala Olidesk."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți Olidesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți Olidesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți Olidesk să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [Olidesk Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep Olidesk background service", "Rulează serviciul Olidesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației Olidesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi Olidesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi Olidesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din Olidesk care rulează."),
        ...
        ("verify_Olidesk_password_tip", "Verifică parola Olidesk"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi Olidesk pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_Olidesk_server_pro_{}_tip", "Versiunea serverului Olidesk Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul Olidesk pentru simulare la nivel de kernel"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web Olidesk Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări Olidesk. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("web_id_input_tip", "Introdu ID-ul Olidesk al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_Olidesk_client_to_{}_tip", "Versiunea clientului Olidesk de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește Olidesk Pro pentru funcționalitate completă."),
