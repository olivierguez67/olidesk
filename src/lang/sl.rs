...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem Olidesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, Olidesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate Olidesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate Olidesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno Olidesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »Olidesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep Olidesk background service", "Ohrani Olideskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije Olidesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "Olidesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "Olidesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_Olidesk_password_tip", "Preveri geslo za Olidesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite Olidesk, prekinite klic in program zaprite."),
        ("scam_text2", "Olidesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_Olidesk_server_pro_to_{}_tip", "Prosimo, nadgradite Olidesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo Olidesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno Olideska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri Olidesk storitvi v ozadju"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_Olidesk_client_to_{}_tip", "Prosimo, nadgradite Olidesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
