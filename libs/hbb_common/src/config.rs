...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("com.olisys".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Olidesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["172.104.159.65"];
pub const RS_PUB_KEY: &str = "EGqVdupRKVkYGxd9p7rHC0oQgCw0cKrbtuidT485xpY=";
